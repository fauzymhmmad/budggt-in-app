    ...
    <div className="p-5 rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Latest recorded income & expenses</p>
        </div>
      ...
      {recentTxs.length === 0 ? (
        <div className="py-10 text-center text-xs text-slate-400">
          No transactions yet. Click "+ Add" to record your first transaction.
        </div>
      ) : (
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-400 mt-0.5">
                      ...
                      <span>•</span>
                      <span className="truncate">{acc?.name || 'Main Account'}</span>
                    </div>
                  </div>
                </div>
