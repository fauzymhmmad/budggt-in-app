  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Savings Goals & Sinking Funds</h3>
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Set target funds for vacations, emergency cushions, equipment, and future milestones
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
          ...
          <div className="text-xs text-slate-400 mt-1">
            across {goals.length} target milestones
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
          ...
          <div className="text-xs text-slate-400 mt-1">
            Distance to all target finishes
          </div>
        </div>
      </div>
      ...
      {goals.length === 0 ? (
        <div className="py-16 text-center rounded-2xl bg-white/50 dark:bg-slate-900/50 border border-slate-200/60 dark:border-slate-800 p-8">
          ...
          <h4 className="text-base font-bold text-slate-900 dark:text-white">No Savings Goals Set</h4>
          <p className="text-xs text-slate-400 max-w-sm mx-auto mt-1 mb-4">
            Create structured savings pots with target dates to stay motivated and hit your milestones.
          </p>
          <button
            onClick={() => handleOpenAdd()}
